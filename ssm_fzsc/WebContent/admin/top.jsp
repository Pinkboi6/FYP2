...
<div class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		<a class=""><span class="navbar-brand"><span class="fa fa-paper-plane"></span>Welcome To Use Background Management System</span></a>
	</div>
	<div class="navbar-collapse collapse" style="height: 1px;">
		<ul id="main-menu" class="nav navbar-nav navbar-right">
			...
			<li class="dropdown hidden-xs"><a href="<%=basePath%>admin/editpwd.jsp" title=""><span>Password Change</span></a></li>
			<li class="dropdown hidden-xs"><a href="<%=basePath%>admin/exit.action"
				onclick="{if(confirm('Are you sure you want to quit?')){return true;}return false;}" title=""><span>Exit</span></a></li>
		</ul>
	</div>
</div>