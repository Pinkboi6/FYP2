...
<body class=" theme-blue">
	...
	<div class="content">
		<div class="header">
			<h1 class="page-title">New News Announcement Information</h1>
		</div>
						...
						<form action="article/addArticle.action" name="myform" method="post" onsubmit="return check()" class="form">
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>Title</label> <input type="text" name="title" class="form-control" id="title" placeholder="please enter title" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									...
									<textarea cols="80" name="contents" id="contents" rows="10" placeholder="please enter content"> </textarea>
